...
List<OnBoarding> onBoardinglist = [
  OnBoarding(
    title:
        "Advancing public safety through the fusion of technology and law enforcement expertise.",
    image: ImagesPath.kOnboarding1,
    description:
        'Welcome to CyberCops, your trusted partner in leveraging technology for smarter policing and safer communities.',
  ),
  OnBoarding(
      title: 'Bridging Communities and Police ',
      image: ImagesPath.kOnboarding2,
      description:
          'At CyberCops, we believe in fostering stronger connections between law enforcement and communities through innovative solutions.'),
  OnBoarding(
      title: "Innovation in Policing",
      image: ImagesPath.kOnboarding3,
      description:
          "With CyberCops, we're revolutionizing policing by making our cities safer, one click at a time."),
];
